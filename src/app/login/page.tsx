        ...
        {activeTab === 'login' && (
          <form onSubmit={handleLoginSubmit} className="space-y-4">
            ...
            <div className="pt-4 border-t border-slate-100 space-y-3">
              ...
              {/* Akun Uji Coba Cepat (Multi-User Demo) */}
              <div className="bg-emerald-50/70 p-3 rounded-2xl border border-emerald-100 space-y-2">
                <span className="text-[10px] font-extrabold uppercase tracking-wider text-emerald-800 flex items-center gap-1.5 justify-center">
                  <ShieldCheck className="w-3.5 h-3.5 text-emerald-700" />
                  Uji Coba Login Multi-User / Multi-Role
                </span>
                <div className="grid grid-cols-2 gap-1.5">
                  <button
                    ...
                    className="px-2.5 py-1.5 bg-white hover:bg-emerald-100/70 text-slate-800 hover:text-emerald-900 border border-emerald-200 rounded-xl text-[11px] font-bold transition-all text-left flex items-center justify-between shadow-2xs"
                  >
                    <span>👑 Admin</span>
                    <span className="text-[9px] font-mono text-emerald-700">isi</span>
                  </button>
                  <button
                    type="button"
                    onClick={() => {
                      setLoginEmail('guru@sekolah.sch.id');
                      setLoginPassword('password123');
                      setError('');
                    }}
                    className="px-2.5 py-1.5 bg-white hover:bg-emerald-100/70 text-slate-800 hover:text-emerald-900 border border-emerald-200 rounded-xl text-[11px] font-bold transition-all text-left flex items-center justify-between shadow-2xs"
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      setLoginEmail('staff@sekolah.sch.id');
                      setLoginPassword('password123');
                      setError('');
                    }}
                    className="px-2.5 py-1.5 bg-white hover:bg-emerald-100/70 text-slate-800 hover:text-emerald-900 border border-emerald-200 rounded-xl text-[11px] font-bold transition-all text-left flex items-center justify-between shadow-2xs"
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      setLoginEmail('orangtua@sekolah.sch.id');
                      setLoginPassword('password123');
                      setError('');
                    }}
                    className="px-2.5 py-1.5 bg-white hover:bg-emerald-100/70 text-slate-800 hover:text-emerald-900 border border-emerald-200 rounded-xl text-[11px] font-bold transition-all text-left flex items-center justify-between shadow-2xs"
